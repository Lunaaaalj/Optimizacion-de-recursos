...
insumo_names = {
    1: "Arroz (kg)", 2: "Frijol (kg)", 3: "Tortilla (kg)", 4: "Tomate (kg)",
    5: "Cebolla (kg)", 6: "Papa (kg)", 7: "Zanahoria (kg)", 8: "Espinaca (kg)",
    9: "Champiñones (kg)", 10: "Cilantro (kg)", 11: "Lechuga (pz)",
    12: "Pasta (paq)", 13: "Chile (kg)", 14: "Aceite (L)", 15: "Huevo (unidad)",
    16: "Sal (kg)", 17: "Leche (L)", 18: "Café (kg)", 19: "Agua (L)",
    20: "Azúcar (kg)", 21: "Galletas (paq)", 22: "Pasteles (pz)", 23: "Pan (pz)",
    24: "Atún (lata)", 25: "Pollo (kg)", 26: "Res (kg)", 27: "Refrescos (L)",
    28: "Saborizantes (sobres)", 29: "Harina Maseca (kg)", 30: "Cereal (caja)",
}

dish_names = {
    1: "Huevo con chorizo", 2: "Huevo estrellado", 3: "Huevo con jamón",
    4: "Tortas jamón/queso", 5: "Huevo con papa", 6: "Cereal con leche",
    7: "Huevo/salchicha", 8: "Ensalada de atún", 9: "Pollo frito/pasta",
    10: "Sándwich de pavo", 11: "Milanesa de res", 12: "Guiso de res",
}
...
cost = {
    1: 25.00,  2: 38.00,  3: 25.00,  4: 30.00,  5: 25.00,
    6: 35.00,  7: 20.00,  8: 30.00,  9: 90.00, 10: 50.00,
   11: 20.00, 12: 10.00, 13: 40.00, 14: 38.00, 15:  2.83,
   16: 20.00, 17: 28.00, 18:150.00, 19:  2.50, 20: 35.00,
   21: 15.00, 22:100.00, 23:  3.00, 24: 20.00, 25: 68.00,
   26:180.00, 27: 15.00, 28:  5.00, 29: 22.00, 30: 60.00,
}
...
initial_inv.update({1: 100, 2: 330, 8: 0, 12: 300, 13: 0, 14: 92,
                    17: 7.5, 20: 156, 21: 35, 24: 69, 29: 100})
...
_schedule = {
    (1,  1): 1, (9,  1): 2, (10, 1): 3,   # Lunes
    (5,  2): 1, (12, 2): 2, (4,  2): 3,   # Martes
    (2,  3): 1, (11, 3): 2, (8,  3): 3,   # Miércoles
    (3,  4): 1, (9,  4): 2, (10, 4): 3,   # Jueves
    (7,  5): 1, (12, 5): 2, (4,  5): 3,   # Viernes
    (6,  6): 1, (8,  6): 2, (10, 6): 3,   # Sábado
    (1,  7): 1, (11, 7): 2, (4,  7): 3,   # Domingo
}
...
_tech = {
    # 1: Huevo con chorizo
    (15,1):1.2,  (2,1):0.03, (3,1):0.18, (14,1):0.01,  (18,1):0.005,
    # 2: Huevo estrellado
    (15,2):1.2,  (2,2):0.03, (23,2):1.0, (14,2):0.01,  (18,2):0.005,
    # 3: Huevo con jamón
    (15,3):1.2,  (2,3):0.03, (3,3):0.18, (14,3):0.01,  (18,3):0.005,
    # 4: Tortas jamón/queso
    (23,4):1.0,  (4,4):0.02, (5,4):0.01, (15,4):0.5,   (18,4):0.005,
    # 5: Huevo con papa
    (15,5):1.2,  (6,5):0.05, (2,5):0.03, (3,5):0.18,   (14,5):0.01, (18,5):0.005,
    # 6: Cereal con leche
    (30,6):0.08, (17,6):0.25,(18,6):0.005,
    # 7: Huevo/salchicha
    (15,7):1.2,  (2,7):0.03, (3,7):0.18, (14,7):0.01,  (18,7):0.005,
    # 8: Ensalada de atún
    (24,8):0.5,  (11,8):0.05,(4,8):0.02, (21,8):0.10,
    # 9: Pollo frito/pasta
    (25,9):0.12, (12,9):0.06,(4,9):0.03, (14,9):0.015, (19,9):0.4,
    # 10: Sándwich de pavo
    (23,10):2.0, (4,10):0.02,(5,10):0.01,(6,10):0.04,  (7,10):0.03, (19,10):0.4,
    # 11: Milanesa de res
    (26,11):0.10,(14,11):0.015,(3,11):0.15,(19,11):0.4,
    # 12: Guiso de res
    (26,12):0.10,(6,12):0.04, (4,12):0.03,(3,12):0.15, (19,12):0.4,
}
...
model.z     = pyo.Var(model.M, model.T, model.C, domain=pyo.NonNegativeIntegers)  # porciones
...
model.obj = pyo.Objective(
    expr=pyo.quicksum(model.c_cost[i] * model.x[i, t]
...
model.budget_con = pyo.Constraint(
    expr=pyo.quicksum(model.c_cost[i] * model.x[i, t]
                      for i in model.I for t in model.T) <= model.B
)
            ...
            for c in model.C:
                ...
                for m in model.M:
                    ...
                    if val is not None and val > 0.5:
                        w(f"      Platillo {m:2d} ({dish_names[m]}): {int(round(val))} porciones")
                        any_dish = True
                if not any_dish:
                    w("      (ninguno)")
        ...
        for t in model.T:
            ...
            if purchases:
                ...
                for i, xval, yval, spend in purchases:
                    w(f"    {insumo_names[i]:<30s} {xval:>10.2f}  {yval:>6d}  {spend:>13,.2f}")
            else:
