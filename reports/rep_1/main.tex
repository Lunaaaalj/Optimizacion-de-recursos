...
\rule{\textwidth}{1pt}
{\LARGE\bfseries ANALISIS DE OPTIMIZACIÓ
N DE INVENTARIOS: CASA MONARCA \par}
\vspace{0.5cm}
...
\abstract{
En este documento se mostrará el proceso en el cuál utilizamos  modelos matemáticos con ecuaciones diferenciales, para realizar regresiones tanto de la transición demográfica, como de factores de diversos sectores, como salud y turismo. Utilizamos bases de datos relacionadas con aspectos relevantes de cada sector sobre México y Chile, donde al obtener los resultados se obtuvieron diversas conclusiones sobre el comportamiento de los 2 paises, para lo anterior utilizamos un método de regresión lineal Runge-Kutta.
}
